...
//создаться экземпляр соответствующей версии класса, приведенный к базовому - DocumentWorker.
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            DocumentWorker validUser;
            bool flagValidKey = keyExp == "123";
            if (flagValidKey)
                validUser = new ExpertDocumentWorker();
            else
                validUser = new DocumentWorker();
            DocumentWorker user = validUser as DocumentWorker;
